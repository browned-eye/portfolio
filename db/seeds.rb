...
Project.where(:title_short => "archextract").update_all( tags: 'nlp, web_dev, dbs', toolbox_ids: 'mysql, ruby on rails, ajax, html/css, javascript, python, map reduce, shell scripting', skills:'contextual interviewing, comparative analysis, dev ops, automation, product design, web development', role:'ux research, front and backend web development, dev ops, product design')
...
Project.where(:title_short => "caceo").update_all( tags: 'web_dev',  toolbox_ids: 'ruby on rails, ajax, html/css, mysql, jquery/ajax', skills:'contextual interviewing, dev ops, product design, web development')
